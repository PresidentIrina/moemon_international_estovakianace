...
static const u16 sSpeciesToNationalPokedexNum[NUM_SPECIES - 1] =
{
    ...
    [SPECIES_TYRANITAR_MEGA - 1] = NATIONAL_DEX_TYRANITAR_MEGA,
    [SPECIES_SCEPTILE_MEGA - 1] = NATIONAL_DEX_SCEPTILE_MEGA,
    ...
    [SPECIES_SLOWKING_GALARIAN - 1] = NATIONAL_DEX_SLOWKING_GALARIAN,
...
//Moemon International
    SPECIES_TO_NATIONAL(VALKYRIE),
    SPECIES_TO_NATIONAL(FLAK88),
    SPECIES_TO_NATIONAL(RYUUHOU),
    SPECIES_TO_NATIONAL(ESCAVALIERSUMMER),
    SPECIES_TO_NATIONAL(GARCHOMPBUNNY),
    SPECIES_TO_NATIONAL(VELUZA),
    SPECIES_TO_NATIONAL(COBALIONBUNNY),
    SPECIES_TO_NATIONAL(TERRAKIONBUNNY),
    SPECIES_TO_NATIONAL(VIRIZIONBUNNY),
};
...
//Moemon International
    [SPECIES_VALKYRIE - 1]          = ANIM_V_SHAKE,
    [SPECIES_FLAK88 - 1]            = ANIM_V_SHAKE,
    [SPECIES_RYUUHOU - 1]           = ANIM_V_SHAKE,
    [SPECIES_ESCAVALIERSUMMER - 1]  = ANIM_BACK_AND_LUNGE,
    [SPECIES_GARCHOMPBUNNY - 1]     = ANIM_V_SHAKE_TWICE,
    [SPECIES_VELUZA - 1]            = ANIM_V_SHAKE,
    [SPECIES_COBALIONBUNNY - 1]     = ANIM_V_STRETCH,
    [SPECIES_TERRAKIONBUNNY - 1]    = ANIM_V_SHAKE_TWICE,
    [SPECIES_VIRIZIONBUNNY - 1]     = ANIM_GROW_VIBRATE,
};
