...
static const u32 sMugshotImg_Colress[] = INCBIN_U32("graphics/mugshots/MUGSHOT_COLRESS.4bpp.lz");
static const u16 sMugshotPal_Colress[] = INCBIN_U16("graphics/mugshots/MUGSHOT_COLRESS.gbapal");
...
static const struct Mugshot sMugshots[] = {
    ...
    [MUGSHOT_COLRESS] = {.x = 6, .y = 2, .width = 80, .height = 80, .image = sMugshotImg_Colress, .palette = sMugshotPal_Colress},
};
