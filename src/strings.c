...
const u8 gText_ProfBirchMatchCallName[] = _("Professor Birch");
...
const u8 gText_HOFDexRating[] = _("Spotted Moémon: {STR_VAR_1}!\nOwned Moémon: {STR_VAR_2}!\pProfessor Birch's Moédex rating!\pPROF. BIRCH: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("Professor Birch is in trouble!\nRelease a Moémon and rescue him!");
...
const u8 gText_DoWhatWithPokemon[] = _("Do what with this Moémon?");
...
const u8 gText_MonTypeAndNo[] = _("Moémon TYPE & NO.");
...
const u8 gText_BattleMon[] = _("BATTLE Moémon");
...
const u8 gText_CantSelectSamePkmn[] = _("Can't select same Moémon.");
...
const u8 gText_PkmnForSwap[] = _("Moémon FOR SWAP");
...
const u8 gText_SamePkmnInPartyAlready[] = _("Same Moémon in party already.");
...
const u8 gText_WallyMatchCallDesc[] = _("Moémon Lover");
...
const u8 gText_ProfBirchMatchCallDesc[] = _("Moémon Prof.");
