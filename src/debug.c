...
static const u8 sDebugText_Flags_SetPokedexFlags[] =    _("All Moédex Flags");
static const u8 sDebugText_Flags_SwitchDex[] =          _("Moédex ON/OFF");
static const u8 sDebugText_Flags_SwitchNationalDex[] =  _("NatDex ON/OFF");
static const u8 sDebugText_Flags_SwitchPokeNav[] =      _("MoéNav ON/OFF");
