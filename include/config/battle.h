...
#define B_SYNCHRONIZE_NATURE        GEN_LATEST // In Gen8, if a Moémon with Synchronize is leading the party, it's 100% guaranteed that wild Moémon will have the same ability, as opposed to 50% previously.
